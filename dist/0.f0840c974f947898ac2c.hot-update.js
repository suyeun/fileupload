...
let UserRepository = exports.UserRepository = class UserRepository {
    ...
    //channelId, name, email
    create(channelId, name, email) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const raw2 = yield this.dataSource.getRepository(entities_1.User).find({
                select: [
                    "id",
                    "name",
                    "email",
    ...
    findChannelId(channelId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const raw = yield this.dataSource.getRepository(entities_1.User).find({
                select: [
                    "id",
                    "name",
                    "email",
    ...
    //certificationKey 업데이트  birthday, phone, certificationKey
    updateCertificationKey(userId, userDatas) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { raw } = yield this.dataSource.getRepository(entities_1.User).update({
                    id: userId,
                }, {
                    certificationKey: userDatas.certificationKey,
    ...
    findDeviceId(deviceId) {
        return __awaiter(this, void 0, void 0, function* () {
            const raw = yield this.dataSource.getRepository(entities_1.User).find({
                select: ["id", "name", "email", "platform", "role", "accessToken"],
                where: {
                    deviceId: deviceId,
                },
                order: {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("d26ae6260028d700bb80")
/******/ })();
/******/ 
/******/ }
;